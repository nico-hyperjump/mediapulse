...
3. **Analysis Agent** - Performs analysis using a plugin-based system. By default includes sentiment analysis, competitive landscape research, and event/context analysis. New analysis types can be added dynamically via database registration
